...
def get_character_movies_from_api(character_name)
  ...
  url = "https://www.swapi.co/api/people/?search=#{character_name}"
  ...
  character_film_urls = character_data["films"]
  ...
  character_film_urls.each do |link|
    film_response_string = RestClient.get(link)
